const CACHE = 'abg-v2-red-v1';
const ASSETS = [
  './','./index.html','./styles/app.css','./manifest.webmanifest',
  './src/app.js','./src/ui.js','./src/generator.js','./src/sw-reg.js',
  './data/archetypes.js','./data/venues.js','./data/platforms.js',
  './data/ethnicity.js','./data/signals.js','./data/edgy.js',
  './data/cities/la.js','./data/cities/vegas.js','./data/cities/houston.js',
  './data/cities/slc.js','./data/cities/nyc.js','./data/cities/bayarea.js',
  './data/cities/seattle.js'
];
